          ...
          <nav className="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0">
            ...
            <div className="collapse navbar-collapse" id="navbarCollapse">
              <div className="navbar-nav ms-auto py-0">
                ...
                <span onClick={() => navigate ("/")} href="admin.html" className="nav-item nav-link">
                  Admin
                </span>
                <span onClick={() => navigate ("/")} href="./doctor.html" className="nav-item nav-link">
                  Doctor
                </span>
                <span onClick={() => navigate ("/")} href="recepition.html" className="nav-item nav-link">
                  Recepition
                </span>
                <span onClick={() => navigate ("/")} href="contact.html" className="nav-item nav-link">
                  Contact
                </span>
                <span onClick={() => navigate ("/")} href="about.html" className="nav-item nav-link">
                  About
                </span>
                <span onClick={() => navigate ("/")} href="service.html" className="nav-item nav-link">
                  Service
                </span>
              </div>
            </div>
