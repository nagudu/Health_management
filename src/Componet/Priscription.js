...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    {
    user&&user?.role==='receptionist'||'admin'?
    <li class="nav-item">
...
<Col md={4}>
                            <Card>
                                ...
                                <CardFooter><Button color="primary" onClick={()=>navigate(`/priscription-form?patient_id=${item.id}&id=${user&&user?.id}`)}>Prescibe a drug</Button></CardFooter>
                            </Card>
                        </Col>
                            ))
                        }
