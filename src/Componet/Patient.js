...
export default function Patient() {
  ...
  return (
    <div>
          ...
          <div className="row">
            <div className="col-md-6 text-center text-lg-start mb-2 mb-lg-0">
              <div className="d-inline-flex align-items-center">
                <span onClick={() => navigate("/patient")} className="text-decoration-none text-body pe-3" href="">
                  <i className="bi bi-telephone me-2"></i>+234812 345 6789
                </span>
                <span className="text-body">|</span>
                <span onClick={() => navigate("/patient")} className="text-decoration-none text-body px-3" href="">
            ...
            <div className="col-md-6 text-center text-lg-end">
              <div className="d-inline-flex align-items-center">
                <span onClick={() => navigate("/patient")} className="text-body px-2" href="">
                ...
                <span onClick={() => navigate("/patient")} className="text-body ps-2" href="">
      ...
      <div className="container-fluid sticky-top bg-white shadow-sm mb-5">
        <div className="container">
          <nav className="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0">
            <span onClick={() => navigate("/patient")} href="index.html" className="navbar-brand">
            ...
            <div className="collapse navbar-collapse" id="navbarCollapse">
              <div className="navbar-nav ms-auto py-0">
                ...
                {/* <span onClick={() => navigate("/patient")} href="#" className="nav-item nav-link">Audio Call</span>
                        <span onClick={() => navigate("/patient")} href="#" className="nav-item nav-link">Vidoe Call</span> */}
              </div>
            </div>
          </nav>
        </div>
          ...
          <div className="row g-5">
            ...
            <div className="col-lg-3 col-md-6">
              ...
              <div className="d-flex flex-column justify-content-start">
                <span onClick={() => navigate("/patient")} className="text-light mb-2" href="#">
                ...
                <span onClick={() => navigate("/patient")} className="text-light" href="#">
      ...
      <span onClick={() => navigate("/patient")} href="#" className="btn btn-lg btn-primary btn-lg-square back-to-top">
