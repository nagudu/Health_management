...
import { Button, CardBody, Col, Row,Card, CardFooter} from "reactstrap";
              ...
              <div class="row">
                <div class="col-xl-12 col-lg-12">
                  <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <Button color='primary' onClick={()=>navigate('/doctor-form')} className="mb-3">Add a Doctor</Button>
                     <Row   >
                        {
...
<Col md={4}>
                            <Card>
                                <CardBody className="d-flex">
                                  <div>
                                    <img src={require('./download.png')} className="rounded" />
                                  </div>
                                  <div className="mt-5">
                                    <span><b>name: </b>DR . {item.firstname}</span><br />
                                    <span><b>gender: </b> {item.gender}</span><br />
                                    <span><b>phone: </b> {item.phone}</span><br />
                                    <span><b>status: </b> {item.status}</span><br />
                                  </div>
                                </CardBody>
                                <CardFooter><Button color="danger">suspend</Button></CardFooter>
                            </Card>
                        </Col>
                            ))
                        }
